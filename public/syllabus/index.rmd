...
Groups are to consist of between 4 and 5 members. I will not entertain requests for groups of fewer than 4 or more than 5 members. You are required to deal with group dynamics within the group. Once we form groups you are required to remain with that group throughout the course. Working in a team is an important part of life. Form groups based on skill-sets; no group needs 5 project managers or 5 programmers. Find people with complementary skills and not substitutable skills. Find group members that you can work well with and not necessarily your friends. The idea is to excel and not to simply **fit in**.
