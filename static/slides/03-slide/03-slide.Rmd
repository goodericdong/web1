...
# Brief Steps of Capital Budgeting
...
knitr::include_graphics("16-budget.jpg")
```
...
- For an N year project, here is what we do:
  ...
  1. Estimate initial investment ( $C_0$ )
...
.large[Initial investment may include:]
...
- Changes in Net working capital
  - Current Assets – Current Liabilities [Note: this is a simplified definition]
  - Firms need to keep certain amount of cash in their vault to be able to eliminate the liquidity mismatch (e.g. In order to manufacture a good, you purchase raw material. You process it and you sell it but some customers do not pay cash. You may get a cheque which is due a future date.
  - Hint: you usually get Net Working capital back at the end of project

- Opportunity costs
  - What would you do with that money if you did not purchase this equipment for this project?

**Note**: Do not include sunk costs already spent and that cannot be recovered
